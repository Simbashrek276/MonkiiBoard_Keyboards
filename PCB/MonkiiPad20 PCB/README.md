...
I started with the components themselves, dropping down footprints for the switches before anything was wired up.

![Early 3D render of the board with just the switch footprints placed, nothing routed yet](../../Medias/MonkiiPad20/MonkiiPad20_PCB/MonkiiPad20_PCB_design.png)

Another early pass, with the OLED header added in but the diodes and the controller still to come.

![Another early render of the board with the OLED header footprint added but no diodes or controller placed yet](../../Medias/MonkiiPad20/MonkiiPad20_PCB/MonkiiPad20_PCB_design3.png)

From there I looked back at how I'd hand wired the original MonkiiPad20 and turned that into a proper schematic, the full matrix with a diode on every switch, the OLED header and the RP2040-Zero pinout all laid out.
...
A good stretch of PCB designing followed, placing the diodes and the controller and figuring out where everything could actually sit.

![3D render with the diodes placed on the back of the board and the RP2040-Zero footprint dropped in, USB-C and all](../../Medias/MonkiiPad20/MonkiiPad20_PCB/MonkiiPad20_PCB_design1.png)

![Checking the RP2040-Zero footprint up close against the board edge and a mounting hole](../../Medias/MonkiiPad20/MonkiiPad20_PCB/MonkiiPad20_PCB_design4.png)

That period of designing is what led to design 2, the first version with every trace actually routed end to end.

![Design 2, the PCB editor view with every trace routed between the switches, diodes and the controller header](../../Medias/MonkiiPad20/MonkiiPad20_PCB/MonkiiPad20_PCB_design2.png)

Design 5 is the one that actually became this board, a second pass over design 2 with a handful of routing tweaks to clear up bugs and errors before sending it off to be made.

![Design 5, the routing cleaned up from design 2 to fix a handful of bugs before this went off to be made](../../Medias/MonkiiPad20/MonkiiPad20_PCB/MonkiiPad20_PCB_design5.png)
